...
//			IDENTITY_TYPE_WEGAME = k_ESteamNetworkingIdentityType_WeGame,
		...
		bool serverInit(const String& ip, uint16 game_port, uint16 query_port, int server_mode, const String& version_number);
		Dictionary serverInitEx(const String& ip, uint16 game_port, uint16 query_port, int server_mode, const String& version_number);
